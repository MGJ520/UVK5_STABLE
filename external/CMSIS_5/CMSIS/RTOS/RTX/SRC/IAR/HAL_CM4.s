...
SVC_Handler:
        ...
        LDR     R3,=os_tsk
        LDM     R3,{R1,R2}              /* os_tsk.build, os_tsk.next */
        CMP     R1,R2
        IT      EQ
...
SVC_ContextSave:
        ...
        MOVNE   R0,#0x00
        STRB    R0,[R1,#TCB_STACKF]     /* os_tsk.build->stack_frame = val */
        STMDB   R12!,{R4-R11}           /* Save Old context */
        STR     R12,[R1,#TCB_TSTACK]    /* Update os_tsk.build->tsk_stack */
...
SVC_ContextRestore:
        STR     R2,[R3]                 /* os_tsk.build = os_tsk.next */
