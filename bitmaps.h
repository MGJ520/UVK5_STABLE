...
extern const uint8_t BITMAP_POWERSAVE[10];
//增加
extern const uint8_t BITMAP_SCAN[11];
//extern const unsigned char bitmap_bit_bytes[];
...
#ifdef ENABLE_VOX
extern const uint8_t BITMAP_VOX[8];
#endif
